...
export default function Home() {
    return (
        <section className="flex flex-col items-center justify-start min-h-screen overflow-x-hidden bg-indigo-950">
            <Navbar />
            <div className="relative flex flex-col items-center justify-center gap-20 w-screen h-[60vh]">
                <Banner />
                ...
                <Image
                    ...
                    height={1080}
                    alt="smth"
                    className="object-cover h-[60vh] object-center opacity-10 absolute inset-0 w-screen"
                />
